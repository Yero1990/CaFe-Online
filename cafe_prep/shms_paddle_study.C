void shms_paddle_study(){
  ...
  c1->cd();
  T->Draw("CTime.epCoinTime_ROC2>>hcoin_time(100,0,400)");
  ...
  c2->cd(2);
  // S1X- occupancy
  T->Draw("P.hod.1x.numGoodNegAdcHits>>S1X-_noCuts(100,0.01,14)", "");
  T->Draw("P.hod.1x.numGoodNegAdcHits>>S1X-_ctime(100,0.01,14)", "CTime.epCoinTime_ROC2>0&&CTime.epCoinTime_ROC2<20.", "sames");
  T->Draw("P.hod.1x.numGoodNegAdcHits>>S1X-_ctime.AND.delta>=5(100,0.01,14)", "CTime.epCoinTime_ROC2>0&&CTime.epCoinTime_ROC2<20.&&P.gtr.dp>=5", "sames");

  c2->cd(3);
  // S2X+ occupancy
  T->Draw("P.hod.2x.numGoodPosAdcHits>>S2X+_noCuts(100,0.01,14)", "");
  T->Draw("P.hod.2x.numGoodPosAdcHits>>S2X+_ctime(100,0.01,14)", "CTime.epCoinTime_ROC2>0&&CTime.epCoinTime_ROC2<20.", "sames");
  T->Draw("P.hod.2x.numGoodPosAdcHits>>S2X+_ctime.AND.delta>=5(100,0.01,14)", "CTime.epCoinTime_ROC2>0&&CTime.epCoinTime_ROC2<20.&&P.gtr.dp>=5", "sames");

  c2->cd(4);
  // S2X- occupancy
  T->Draw("P.hod.2x.numGoodNegAdcHits>>S2X-_noCuts(100,0.01,14)", "");
  T->Draw("P.hod.2x.numGoodNegAdcHits>>S2X-_ctime(100,0.01,14)", "CTime.epCoinTime_ROC2>0&&CTime.epCoinTime_ROC2<20.", "sames");
  T->Draw("P.hod.2x.numGoodNegAdcHits>>S2X-_ctime.AND.delta>=5(100,0.01,14)", "CTime.epCoinTime_ROC2>0&&CTime.epCoinTime_ROC2<20.&&P.gtr.dp>=5", "sames");
  ...
  */
  ...
  //  T->Draw("P.kin.primary.W>>ctime.AND.delta>=5(40,0.85,1.05)", "CTime.epCoinTime_ROC2>0&&CTime.epCoinTime_ROC2<20.&&P.gtr.dp>=5", "sames");
  //T->Draw("P.kin.primary.W>>a(40,0.85,1.05)", "CTime.epCoinTime_ROC2>0&&CTime.epCoinTime_ROC2<20.&&P.gtr.dp>=5&&P.hod.1x.numGoodPosAdcHits>=7&&P.hod.1x.numGoodNegAdcHits>=7&&P.hod.2x.numGoodPosAdcHits>=7&&P.hod.2x.numGoodNegAdcHits>=7", "sames");
