...
Brief: this script uses measured data, SIMC quantities from Ca48 MF runs
to extract the areal thickness from contamination (assuming olive oil) for now
Olive Oil: C88_H164_O10, so the areal thickness for each of these elements is 
calculated separately by scaling from the measured H-contamination
