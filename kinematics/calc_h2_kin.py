...
def calc_h2_kin():
    ...
    # This function is specific ONLY for deuteron experiment (E12-10-003)
    # Assuming the deuteon kinematics file exists already.
    ...
    f = B.get_file(fname)
    Pr = B.get_data(f, 'Pr')      # central recoil momentum setting in deuteron [GeV]
    the = B.get_data(f, 'th_e')   # central e- scattering angle [deg]
